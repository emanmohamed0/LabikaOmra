...
//        mUser_Id =getIntent().getStringExtra("mUser_Id");
        mUser_Id = Global.get_UserID(MainActivity.this,"mUser_Id");
...
//                    Toast.makeText(MainActivity.this, R.string.error_num, Toast.LENGTH_SHORT).show();
                ...
                Intent homeIntent = new Intent(com.app.emaneraky.omrati.activities.MainActivity.this, OffersActivity.class);
...
//                    check_out.setText(getDate());
        ...
        check_out.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog mDate = new DatePickerDialog(com.app.emaneraky.omrati.activities.MainActivity.this, dateto, to
        ...
        check_in.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog mDate = new DatePickerDialog(com.app.emaneraky.omrati.activities.MainActivity.this, datefrom, from
