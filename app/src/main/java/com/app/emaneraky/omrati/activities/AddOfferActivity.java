...
//        spinnerTransLevel = (Spinner) findViewById(R.id.spinner_trans);
        ...
        progressDialog = new ProgressDialog(com.app.emaneraky.omrati.activities.AddOfferActivity.this);
...
//                location = getAddress(ChooseLocationActivity.lat, ChooseLocationActivity.lang);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case Date_id:
                ...
                return new DatePickerDialog(com.app.emaneraky.omrati.activities.AddOfferActivity.this, date_listener, year,
                        month, day);
            case Time_id:
                // Open the timepicker dialog
                return new TimePickerDialog(com.app.emaneraky.omrati.activities.AddOfferActivity.this, time_listener, hour,
                        minute, false);
        }
        return null;
    }
    ...
    public String getAddress(double lat, double lng) {
        Geocoder geocoder = new Geocoder(com.app.emaneraky.omrati.activities.AddOfferActivity.this, Locale.getDefault());
        try {
